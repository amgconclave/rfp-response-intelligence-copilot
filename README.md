...
- Deal Readiness / Executive Report tab showing readiness score, blockers, owner bottlenecks, section completeness, reviewer bottlenecks, readiness scorer eval scenarios, and generated `storage/readiness_packs/` plus `storage/readiness_score_evals/` artifact paths.
