...
class ReleaseService:
    ...
    def _coverage(self, smoke_matrix: SmokeMatrixResponse) -> dict[str, Any]:
        ...
        return {
            ...
            "procurement_exception_monitor": {
                "service_path": "app/services/procurement_exception_monitor.py",
                "artifact_root": str((self.settings.storage_dir / "procurement_exception_monitor").resolve()),
                "endpoints": ["/procurement/exception-monitor", "/procurement/exception-monitor-pack"],
            },
            "bid": {
    ...
    def _artifact_coverage(self, smoke_matrix: SmokeMatrixResponse) -> dict[str, Any]:
        expected_dirs = {
            ...
            "procurement_exception_monitor": "Procurement exception expiry and evidence monitor packs",
