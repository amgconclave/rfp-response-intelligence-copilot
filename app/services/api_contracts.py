...
class ApiContractService:
    ...
    def _demo_check(self) -> ApiContractCheck:
        ...
        required = {
            ...
            "/governance/access-policy-pack": "access_policy_pack",
            "storage/access_policy": "access_policy",
            "/procurement/approval-pack": "procurement_approval_pack",
            "storage/procurement_packs": "procurement_packs",
            "/procurement/risk-desk-pack": "procurement_risk_desk_pack",
            "storage/procurement_risk_desk": "procurement_risk_desk",
            "/procurement/risk-decision-pack": "procurement_risk_decision_pack",
            "storage/procurement_risk_decisions": "procurement_risk_decisions",
            "/procurement/exception-monitor-pack": "procurement_exception_monitor_pack",
            "storage/procurement_exception_monitor": "procurement_exception_monitor",
            "/rfp/reviewer-collaboration-pack": "reviewer_collaboration_pack",
            "storage/review_boards": "review_boards",
            "/rfp/reviewer-signoff-pack": "reviewer_signoff_pack",
            "storage/reviewer_signoffs": "reviewer_signoffs",
            ...
            "/rfp/objection-audit-pack": "objection_audit_pack",
            "storage/objection_audits": "objection_audits",
            "/rfp/answer-reuse-library-pack": "answer_reuse_library_pack",
            "storage/answer_reuse_library": "answer_reuse_library",
            "/rfp/answer-reuse-drift-pack": "answer_reuse_drift_pack",
            "storage/answer_reuse_drift": "answer_reuse_drift",
            "/rfp/answer-reuse-approval-pack": "answer_reuse_approval_pack",
            "storage/answer_reuse_approvals": "answer_reuse_approvals",
            "/rfp/answer-reuse-eval-pack": "answer_reuse_eval_pack",
            "storage/answer_reuse_evals": "answer_reuse_evals",
            ...
            "/evidence/freshness-sla-pack": "freshness_sla_pack",
            "storage/freshness_sla": "freshness_sla",
            ...
            "/proposal/intake-triage-pack": "proposal_intake_pack",
            "storage/proposal_intake": "proposal_intake",
            ...
            "/proposal/buyer-contracts-pack": "buyer_structured_contracts_pack",
            "storage/buyer_contracts": "buyer_contracts",
            "/proposal/agent-council-pack": "agent_council_pack",
            "storage/agent_council": "agent_council",
            "/proposal/tool-trust-pack": "tool_trust_pack",
            "storage/tool_trust": "tool_trust",
            "/proposal/decision-provenance-pack": "decision_provenance_pack",
            "storage/decision_provenance": "decision_provenance",
            "/proposal/submission-certification-pack": "submission_certification_pack",
            "storage/submission_certifications": "submission_certifications",
            "/proposal/review-gate-pack": "proposal_review_gate_pack",
            "storage/proposal_review_gates": "proposal_review_gates",
            "/proposal/release-room-pack": "proposal_release_room_pack",
            "storage/proposal_release_room": "proposal_release_room",
    ...
    def _sample_body(self, path: str, smoke_command: str) -> str | None:
        ...
        bodies = {
            ...
            "/governance/access-policy-pack": '{"write_artifact":true}',
            "/procurement/approval-pack": '{"write_artifact":true}',
            "/procurement/risk-desk-pack": '{"write_artifact":true}',
            "/procurement/risk-decision-pack": '{"write_artifact":true}',
            "/rfp/reviewer-collaboration": "{}",
            "/rfp/reviewer-collaboration-pack": '{"write_artifact":true}',
            "/rfp/reviewer-signoff-ledger": "{}",
            "/rfp/reviewer-signoff-pack": '{"write_artifact":true}',
            ...
            "/rfp/objection-audit": '{"competitor_context":["Incumbent competitor is cheaper."],"top_k":4}',
            "/rfp/objection-audit-pack": '{"write_artifact":true}',
            "/rfp/clarification-questions": '{"top_k":4,"max_questions":8}',
            "/rfp/clarification-question-pack": '{"write_artifact":true}',
            "/rfp/answer-reuse-library": '{"customer_profile_id":"regulated_healthcare"}',
            "/rfp/answer-reuse-library-pack": '{"write_artifact":true}',
            "/rfp/answer-reuse-drift": '{"customer_profile_id":"regulated_healthcare","min_source_overlap":4}',
            "/rfp/answer-reuse-drift-pack": '{"write_artifact":true}',
            "/rfp/answer-reuse-approval-ledger": '{"customer_profile_id":"regulated_healthcare"}',
            "/rfp/answer-reuse-approval-pack": '{"write_artifact":true}',
            "/rfp/answer-reuse-eval": '{"customer_profile_id":"regulated_healthcare","min_source_overlap":4}',
            "/rfp/answer-reuse-eval-pack": '{"write_artifact":true}',
            ...
            "/proposal/buyer-contracts-pack": '{"write_artifact":true}',
            "/proposal/agent-council-pack": '{"write_artifact":true}',
            "/proposal/tool-trust-pack": '{"write_artifact":true}',
            ...
            "/proposal/review-gate-pack": '{"write_artifact":true}',
            "/proposal/release-room-pack": '{"write_artifact":true}',
