    ...
    def _smoke_rows(self) -> list[SmokeMatrixRow]:
        return [
            ...
            self._row(
                ...
                "enterprise",
                200,
                "Returns durable reviewer signoff readiness, policy gates, and human review queue.",
                body="{}",
            ),
            self._row(
            ...
            self._row(
                ...
                "enterprise",
                200,
                "Returns cross-artifact reviewer trace consistency findings, gates, and follow-ups.",
                body="{}",
            ),
            self._row(
                ...
                "artifact",
                200,
                "Writes reviewer trace reconciliation Markdown and JSON artifacts.",
                ["storage/reviewer_reconciliation/*.md", "storage/reviewer_reconciliation/*.json"],
                '{"write_artifact":true}',
            ),
            self._row(
            ...
            self._row(
                "Proposal readiness drift pack",
                "POST",
                "/rfp/proposal-readiness-drift-pack",
                "artifact",
                200,
                "Writes baseline/current readiness drift, workflow routing, and reviewer routes.",
                ["storage/readiness_drift/*.md", "storage/readiness_drift/*.json"],
                '{"write_artifact":true}',
            ),
            self._row(
                "Win strategy",
